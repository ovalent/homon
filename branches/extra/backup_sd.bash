...
VAR_SDsize_f=$(numfmt --to=iec-i --suffix=B $VAR_SDsize)
echo SD card: $VAR_SDcard \(size: $VAR_SDsize_f\)

echo [1/3] Creating img file from SD card \($VAR_outputfolder$VAR_outputfile\)...
...
echo [2/3] Compressing $VAR_outputfile to $VAR_outputzipfile...
pv -tpreb $VAR_outputfolder$VAR_outputfile | pigz > $VAR_outputfolder$VAR_outputzipfile

echo [3/3] Delete $VAR_outputfile file...
